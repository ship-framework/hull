...
class Uri implements UriInterface
{
    ...
    {
        return array_key_exists($this->port, self::PORTS) && self::PORTS[$this->port] === $this->getScheme() ? null : $this->port;
    }
    ...
    {
        if (!\Ship\Hull\Http\Resource\Uri::isValid($scheme)) {

...
class ServerRequest extends Request implements ServerRequestInterface
{
     ...
     */
    public function __construct($serverParams = null, $method = null, $uri = null, $headers = null, $body = null, $protocolVersion = null)
    {
        parent::__construct($method, $uri, $headers, $body, $protocolVersion);

        $this->serverParams = $serverParams !== null ? $serverParams : $_SERVER;
        $this->cookieParams = $_COOKIE;
        $this->queryParams = $this->uri->getQuery();
    ...
    public function withUploadedFiles(array $uploadedFiles)
    {
        foreach ($uploadedFiles as $uploadedFile) {
            if (!($uploadedFile instanceof UploadedFileInterface)) {
                throw new \InvalidArgumentException('Uploaded files must be instance of UploadedFileInterface.');
            }
        }
